...
export default function Page() {
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      {/* When we have an image we cant import and must use src 
      but still want to optimize it and not just pass height and width 
      we put the dimensions (aspect-ratio) in a parent container
       and set Image to fill and object-cover */}
